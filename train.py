...
if 1:
    ...
    # Dataset.
    desc += '-ffhq';     dataset = EasyDict(tfrecord_dir='lfw_tf');                 train.mirror_augment = True
    ...
    sched.G_lrate_dict = {8: 0.0015, 16: 0.002, 32: 0.003, 64: 0.003}
...
if 0:
    ...
    # Dataset (choose one).
    desc += '-celebahq';            dataset = EasyDict(tfrecord_dir='lfw_tf'); train.mirror_augment = True
